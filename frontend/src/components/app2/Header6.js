...
import AllUsers6 from './AllUsers6';
import ReservationResponse6 from './ReservationResponse6';
import RoomResponse6 from './RoomResponse6';
                ...
                <Router>
                        ...
                        <Nav className="navbar navbar-expand-sm bg-dark navbar-dark navItems">
                            ...
                            <li className="nav-item">
                                    <Link to='/allpatients'><div id="tab1" onClick={this.changeActive} className={(this.state.activeTab === "tab1") ? "active nav-link " : "nav-link"}>---FREE ROOM---</div></Link>
                                </li>
                                    ...
                                    <form className="form-inline float-lg-right" action="/">
                                        <div>
                                            ...
                                            <Link to='/searchpatient'>
                                                ...
                                                <button  className="btn btn-success" onClick={(e)=>{this.changeSearch(e); this.changeActive(e)}} type="submit">
                                                    <div className="searchButton" required>Reserve Room</div>
                                                </button>
                                            </Link>
                                        </div>
                                    </form>
                    ...
                    <Route exact strict path='/allpatients' component={AllUsers6}/>
                    <Route exact strict path='/allreservations' component={ReservationResponse6}/>
                    <Route exact strict path='/searchpatient' component={() => (<SearchUser search={this.state.search}/>)}/>
                    <Route exact strict path='/roomStatus' component={RoomResponse6}/>
